...
printf "     (Needed so 'return-architecture' is picked up on your PATH.\n"
printf "     Alternatively, in this terminal: source ~/.local/bin/env)\n"
printf "\n"
printf "  2. Run the setup wizard:\n"
printf "       return-architecture gui\n"
printf "\n"
printf "     This opens a local web page in your browser and walks you\n"
printf "     through a 5-minute setup. You'll need an Anthropic or\n"
